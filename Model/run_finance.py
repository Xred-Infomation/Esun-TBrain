...
show_query_result_length = 8 # retrieve數量
...
def getDB_search(qid, question, faissdb) -> list:
    ...
    prompt_template = PromptTemplate(
        ...
        "- 如果問題中提到第幾季，文件中可能會寫成該季的起始和結束日期（例如：第一季為1月1日至3月31日，）。\n"
        "- 如果問題中提到仟元，等同千元"
...
# 讀取題目
dicts = load_question.getQuestion("../dataset/preliminary/question/questions_finance.json")
...
save_results_to_json(
    answer_dict, "../dataset/preliminary/pred_retrieve_finance.json")
